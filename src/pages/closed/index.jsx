...
const Grievance = () => {
    ...
    const {
        loading, grievanceList, fetchGrievances, deleteSpecificGrievance
    } = useGrievancetore();
    ...
    const columns = [
        {
            ...
            renderCell: (params) => {
                return (
                    <div>{params?.row?.grievance_no}</div>
                )
            }
        },
        {
            ...
            renderCell: (params) => {
                return (
                    <div>{params?.row?.member_name}</div>
                )
            }
        },
        {
            ...
            renderCell: (params) => {
                return (
                    <div className={`chip ${params?.row?.severity_type?.type}`}>{params?.row?.severity_type?.name ? capitalize(params?.row?.severity_type?.name) : ''}</div>
                )
            }
        },
        {
        ...
        },
        {
            ...
            renderCell: (params) => {
                return (
                    <div className={`chip ${params?.row?.status?.type}`}>{params?.row?.status?.name}</div>
                )
            }
        },
        {
            ...
            renderCell: (params) => {
                return (
                    <div>{params?.row?.grievance_received_type?.name}</div>
                )
            }
        },
        {
        ...
        <>
            ...
            <div>
                ...
                <div className="section-heading-row">
                    <h2 className="section-heading">Closed Grievances</h2>
            ...
            </div>
            {
                ...
                <ConfirmationModal
                    open={reopenMode}
                    setOpen={setReopenMode}
                    performAction={deleteGrievance}
                    loading={loading}
                    icon={iconType.Info}
                    heading={"Are you sure you want to reopen this grievance?"}
